...
import {
  REVIEW_CONNECTION_REQ_STATUS_VALUES,
  SEND_CONNECTION_REQ_STATUS_VALUES,
} from "./constants.js";
...
export const checkValidReviewConnectionStatus = (status) => {
  return REVIEW_CONNECTION_REQ_STATUS_VALUES.includes(status);
};
